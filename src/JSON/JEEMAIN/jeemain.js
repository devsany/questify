export const jeemain_sample_1 = [
  ...
  },
  {
    id: 2,
    question:
      "A spherial mirror is obtained as shown in the above figure from a hollow glass sphere. If an object is in front of hte mirror, what will be the ature and magnification of the image of the object? (Figure drawn as schematic and not to scale)",
    Image:
    ...
    options: [
      "Erect, virtual & unmagnified",
      "Inverted, real & magnified",
      "Erect, virtual and magnified",
      "Inverted, real and magnified",
    ],
    answer: "Inverted, real and magnified",
    userAnswer: "",
  },
  {
    id: 3,
    question:
      "In a reactor, 2 Kg of 92(U)235 fuel is fully used up in 30 days. The energy released per fission is 200 MeV,",
    options: ["35MW", "125MW", "60MW", "54MW"],
    answer: "60MW",
    userAnswer: "",
  },
  {
    id: 4,
    question:
      "Interference fringes are observed on a screen by illuminating rwo thin slits 1 mm apart with a light scorce (lambda=6328nm). The distance between the screen and the slits is 100 cm. If a bright fringeis observed on a screen at a distance of 1.27 mm from the central bright fringe, then the path difference between thewaves, which iare reaching this point from the slitsis close to.",

    options: ["2 nm", "1.27um", "2.87nm", "2.05um"],
    answer: "1.27um",
    userAnswer: "",
  },
  {
    id: 5,
    question:
      "Shown in the above figure, a rigid and uniform 1 m long rod AB held in horizontal position by two strings tird to its ends and attached to the ceiling. The rod is of mass m and has another weight of mass 2m hung at a distance of 75 cm from A. The tension in the string at A is.",
    Image:
      "https://rsenhagmfwsoacxeaewi.supabase.co/storage/v1/object/sign/photo/jeemain_sample_paper_1_physics_q_4.jpeg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJwaG90by9qZWVtYWluX3NhbXBsZV9wYXBlcl8xX3BoeXNpY3NfcV80LmpwZWciLCJpYXQiOjE3Mjc1OTc4NzcsImV4cCI6Mjc2NDc1OTc4Nzd9.e-aJJ22HA0HLrPWFlWN46kEu7Xa2tRKov8xMz6hr6kE&t=2024-09-29T08%3A17%3A56.649Z",
    options: ["1 mg", "2 mg", "0.75 mg", "0.5 mg"],
    answer: "1 mg",
    userAnswer: "",
  },
  {
...
export const jeemain_sample_2 = [
  {
    id: 1,
    question:
      "An engine takes 15 moles of air at 20 degree C and 1 atm and compresses it adiabatically to 1/10th of the original volumn. Assuming air to be a diatomic ideal gas made up of rigid molecules, the chande in its internal energy during this process comes out to be XkJ. The value of X to the nearest integer is ....",
    options: ["5", "3", "4", "2"],
    answer: "4",
    userAnswer: "",
  },
  {
    id: 2,
    question:
      "When radiation of wavelength lembda is used to illuminate a metallic surface, the stopping potential is V. When the same surface is illuminated with radiation of wavelength 3 lambda, the stopping potential is V/4. If the threshold wavelength for the metalic surface is n lambda, then value of n will be ....",
  ...
  },
  {
    id: 3,
    question:
      "A circular coil of radius 10 cm is placed in a uniform magnetic field of 3.0 x 10(-5) T with its plane perpendicular to the field initially. It is rotated at constant angular speed about an axis along the diameter of coil and perpendicular to meagnetic field, son that it undergoes half of rotation in 0.2s. The maximum value of emf induced (in micro V) in the coil will be close to the intever.....",
    options: ["15", "12", "60", "54"],
    answer: "15",
    userAnswer: "",
  },
  {
    id: 4,
    question:
      "A small block starts slipping sown from a point B on an inclinde plane AB, Which is making an angle thita with the horizontal section BC is smooth and the remaining section BC is rough with a coefficient of section CA is rough with a coefficient of friction U. Ti is found that th eblock comes to rest as it reaches the bottom (point A) of the inclined plane. If BC = 2 AC, the coefficient of friction is given by u=k tan thita. Then, the value of k is...... ",
      Image:
      "https://rsenhagmfwsoacxeaewi.supabase.co/storage/v1/object/sign/photo/jeemain_sample_paper_1_physics_q_numarical_4.jpeg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJwaG90by9qZWVtYWluX3NhbXBsZV9wYXBlcl8xX3BoeXNpY3NfcV9udW1hcmljYWxfNC5qcGVnIiwiaWF0IjoxNzI3NjM2NzAzLCJleHAiOjM2Mjg3NjM2NzAzfQ.A3nu6Blu48Sn0-RoTZLIKg5JFiRYQl3D9-NuIX01Mfk&t=2024-09-29T19%3A05%3A02.065Z",
    options: ["3", "1", "2", "5"],
    answer: "3",
    userAnswer: "",
  },
  {
    id: 5,
    question:
      "A person of 80 kg mass is standing on the rim of a circular platform of mass 200 kg rotating about its axis at 5 rpm. The person now starts moving towards the  centre of the platform. What will be the  rotational speed (in rpm) of the platform when the person reaches its centre?",
    // Image:
    //   "https://rsenhagmfwsoacxeaewi.supabase.co/storage/v1/object/sign/photo/jeemain_sample_paper_1_physics_q_4.jpeg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJwaG90by9qZWVtYWluX3NhbXBsZV9wYXBlcl8xX3BoeXNpY3NfcV80LmpwZWciLCJpYXQiOjE3Mjc1OTc4NzcsImV4cCI6Mjc2NDc1OTc4Nzd9.e-aJJ22HA0HLrPWFlWN46kEu7Xa2tRKov8xMz6hr6kE&t=2024-09-29T08%3A17%3A56.649Z",
    options: ["1", "8", "7", "9"],
    answer: "9",
