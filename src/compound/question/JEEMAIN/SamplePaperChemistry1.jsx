...
import { jeemain_sample_3_chemistry } from "../../../JSON/JEEMAIN/jeemain";

const SamplePaperChemistry1 = () => {
  ...
  const [questions, setQuestion] = useState(jeemain_sample_3_chemistry);
...
export default SamplePaperChemistry1;
